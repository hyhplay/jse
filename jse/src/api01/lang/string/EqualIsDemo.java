 ...
 * new를 이용하면 heap영역에 새로운 메모리를 할당하고 hashcode를 생성
 */
public class EqualIsDemo {
   public static void main(String[] args) {
	 ...
	 * (조건식) ? "참" : "거짓";
	 */
	String result1 = (str1==str2) ? "str1과 str2는 같다" : "str1과 str2는 다르다";
	String result2 = (str1.equals(str2)) ? "str1과 str2는 같다" : "str1과 str2는 다르다";
	...
	String result3 = (str3==str4) ? "str3과 str4는 같다" : "str3과 str4는 다르다";
	String result4 = (str3.equals(str4)) ? "str3과 str4는 같다" : "str3과 str4는 다르다";
	 ...
	 * 등록하고자 하는 문자열이 상수들에 이미 존재하는 경우에는
	 * 그 문자열의 주소값을 반환한다.
	 */
