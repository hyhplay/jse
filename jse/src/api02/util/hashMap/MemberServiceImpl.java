 ...
 * 인터페이스를 입력하시고 나면, 클래스명에 빨간줄(에러)표시가 뜨는데
 * 마우스를 대시고, add unimplement 를 클릭하세요.
 * 그럼 자동 올버라이딩이 됩니다. 
 * 
 */
public class MemberServiceImpl implements MemberService{
	...
	public void join(String id, String password, String name, int age,
		 ...
		 * valueOf() 는 api.lnag.string.valueOfDemo 참조
		 * 
		 */
